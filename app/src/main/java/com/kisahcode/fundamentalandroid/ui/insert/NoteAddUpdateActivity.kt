...
import com.kisahcode.fundamentalandroid.helper.DateHelper
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set action bar title and button text based on edit mode
        ...
        binding?.btnSubmit?.setOnClickListener {
            ...
            when {
                ...
                description.isEmpty() -> {
                    ...
                    // Set title and description to the note
                    note.let { note ->
                        note?.title = title
                        note?.description = description
                    }

                    // Perform update or insert action based on edit mode
                    if (isEdit) {
     ...
     * Clears the reference to the view binding object to prevent memory leaks.
     */
    ...
    /**
     * Obtains the ViewModel associated with this activity using the ViewModelFactory.
     * @param activity The activity instance.
     * @return The instance of NoteAddUpdateViewModel.
     */
     ...
     * @return Returns true for the menu to be displayed; if it returns false, the menu will not be shown.
     */
     ...
     * @return true if the menu item selection event was handled, false otherwise.
     */
     ...
     * @param type The type of alert dialog to show.
     */
    private fun showAlertDialog(type: Int) {
        ...
        // Determine the title and message of the dialog based on the type
        if (isDialogClose) {
